...
async function getHelpMenu({ client, guild }) {
  ...
  let components = [];
  components.push(
    new ButtonBuilder().setCustomId("previousBtn").setEmoji("1027228364156698664").setStyle(ButtonStyle.Secondary).setDisabled(true),
    new ButtonBuilder().setCustomId("nextBtn").setEmoji("1027228361375887380").setStyle(ButtonStyle.Secondary).setDisabled(true)
  );
